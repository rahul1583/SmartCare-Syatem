...
urlpatterns = [
    ...
    path('lab-reports/<int:report_id>/edit/', views.edit_lab_report_view, name='edit_lab_report'),
    ...
    path('vital-signs/<int:record_id>/edit/', views.edit_vital_signs_view, name='edit_vital_signs'),
]
